...
export type IOnDataSourceNodeProcessing = (
  dataSourceNodeProcessing: DataSourceNodeProcessingResponse,
) => void;
export type IOnDataSourceNodeCompleted = (
  dataSourceNodeCompleted: DataSourceNodeCompletedResponse,
) => void;
export type IOnDataSourceNodeError = (
  dataSourceNodeError: DataSourceNodeErrorResponse,
) => void;
...
function jumpTo(url: string) {
  ...
  if (targetPath === globalThis.location.pathname) return;
          ...
          if (message.startsWith("data: ")) {
            ...
            if (
              ...
              onDataSourceNodeProcessing?.(
                bufferObj as DataSourceNodeProcessingResponse,
              );
            } else if (bufferObj.event === "datasource_completed") {
              onDataSourceNodeCompleted?.(
                bufferObj as DataSourceNodeCompletedResponse,
              );
